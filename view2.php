...
<body style="margin-left: 25px;"><?php
	...
	while($row = mysqli_fetch_array($result)){?>
        ...
        <div id="arrowright">		
            <ul>
                ...
                <img src="images/arrow_images/arrow.png" onerror="this.src='images/default_QK.jpeg';"
        ...
        <div id="arrowleft">
            <ul>
                ...
                <img src="images/arrow_images/arrow-left.png" onerror="this.src='images/default_QK.jpeg';"
                width="100" height="100"></a>
            </ul>
        </div><?php
	}
	...
	$id = $_GET['id'];
	$query = "SELECT * FROM item_list WHERE id = $id ";
	$result =  mysqli_query($db_link, $query);?><?php  
	...
	while($row = mysqli_fetch_array($result)){?>
        ...
        <img id="myimage" src="<?php echo $row['image_path'];  ?>" onerror = "this.src = 'images/default_QK.jpeg';" width="350" height="350">
        <div id="center1">	
            <table border = "1">
                <thead>
                ...
                <tbody>
                    <tr>
                        <td>
                            <a href="view.php?id=<?php echo $id; ?>">
                            <img id="myimage"
                            src="<?php echo $row['image_path']; ?>" onerror = "this.src = 'images/default_QK.jpeg';"
                            width="100" height="100"></a>
                        </td>
                        <td>
