...
<body style="margin-left: 25px;"><?php
	...
	while($row = mysqli_fetch_array($result)){?>
        <div id="arrowright">
            <ul>
                <a href="products-right-admin.php?id=<?php echo $id; ?>" ><img src="images/arrow_images/arrow.png" 
                onerror="this.src='images/default_QK.jpeg';"
                width="100" height="100"></a>
            </ul>
        </div>
        <div id="arrowleft">
            <ul>
                <a href="products-left-admin.php?id=<?php echo $id; ?>"><img src="images/arrow_images/arrow-left.png" 
                onerror="this.src='images/default_QK.jpeg';"
                width="100" height="100"></a>
            </ul>
        </div><?php
	...
	while($row = mysqli_fetch_array($result)){?>
        <div id="center">		
            <strong><font size = "5">Back View:</font></strong>
        </div>
        ...
        <img id="myimage"
        src="<?php echo $row['product_back']; ?>" onerror="this.src='images/default_QK.jpg';"
        width="350" height="350"><?php
        ...
        <form action="change_pix.php" method="post" enctype="multipart/form-data" name="addroom">
            ...
            <center>
                <input type="file" name="back_view">
