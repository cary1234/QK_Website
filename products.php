...
<html lang="en">
	...
	<body onload="showContent()">
				 ...
				 <!-- If access = unconfirmed ("guest only") -->
					...
					<div class="col-lg-2">     
						...
						role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
							<div class="modal-dialog modal-lg">
								<div class="modal-content">
									<center>
										<iframe frameborder = "0" src='products-front-admin.php?id=<?php echo $val; ?>' width="620" height="650">
										</iframe>
									</center>
								</div>
							</div>
						...
						<a  data-target=".bs-example-modal-md_<?php echo $val; ?>" data-toggle="modal" >
							<img class="products-image-size img-responsive" src="<?php echo $row['image_path']; ?>" onerror="this.src='images/default_QK.png';">
						</a>
					</div>
        ...
        <?php require("modal_products.php"); ?>
